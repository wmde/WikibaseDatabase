...
class SQLiteIndexSqlBuilderTest extends \PHPUnit_Framework_TestCase {
	...
	public function fieldAndSqlProvider() {
		...
		$argLists[] = array(
			...
			'CREATE INDEX -prefix_tableName_indexName- ON -prefix_tableName- (-intField-,-textField-);'
		);
		...
		$argLists[] = array(
			...
			'CREATE UNIQUE INDEX -prefix_tableName_indexName- ON -prefix_tableName- (-intField-,-textField-);'
		);
